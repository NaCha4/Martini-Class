...
test('event changes cannot undercut reserved seats or silently omit paid instructions',()=>{assert.throws(()=>validateEvent(event,3));assert.throws(()=>validateEvent({...event,fee:10000},0));assert.doesNotThrow(()=>validateEvent(event,1));});
