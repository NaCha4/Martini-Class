...
const routes=['e','r','about','activities','join','notices','privacy','events','members','admin','admin/events','admin/members','admin/requests','admin/inventory','admin/finance','admin/meetings','admin/decisions','admin/content','admin/settings','admin/admins','admin/roles','admin/privacy','admin/audit'];
