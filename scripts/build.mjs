...
const routes=['about','activities','join','notices','privacy','events','admin','admin/events','admin/members','admin/inventory','admin/finance','admin/meetings','admin/decisions','admin/content','admin/settings','admin/admins','admin/privacy','admin/audit'];
