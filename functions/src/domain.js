...
export const schemas={
 ...
 decision:z.object({...meta,title:required(160),body:text(10000),type:z.enum(['decision','action']),eventId:idSchema.or(z.literal('')).optional(),meetingId:idSchema.or(z.literal('')),agendaId:idSchema.or(z.literal('')).default(''),owner:text(80),dueAt:iso.or(z.literal('')),status:z.enum(['proposed','approved','in_progress','done','deferred']),semester:required(30)}).strict(),
