...
async function receiptPage(ctx,id){
 ...
 if(activeEvent&&a.status==='registered'&&a.fee>0&&e.accountNumber)details+='<section class="receipt-account"><h3>입금 계좌번호</h3><p class="account-number">'+esc(e.accountNumber)+'</p>'+button('계좌번호 복사','account-copy',{class:'button secondary',icon:'copy'})+'</section>';
