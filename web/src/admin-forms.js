...
async function eventEdit(ctx,id){
 ...
 field('accountNumber','입금 계좌번호',r?.accountNumber||'',{wide:true,maxLength:60,inputmode:'numeric',placeholder:'계좌번호를 입력하세요',hint:'숫자와 하이픈으로 입력하세요. 은행명과 예금주는 납부 안내에 적어 주세요.'})+
