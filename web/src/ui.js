import { createIcons, ArrowRight, ArrowUpRight, ArrowLeft, Check, X, CircleX, CalendarDays, UsersRound, Package, NotebookPen, ListChecks, Wallet, Settings2, ShieldCheck, History, LayoutDashboard, LogOut, Sprout, Search, Inbox, Plus, Pencil, Copy, Download, UserPlus, GraduationCap, Users, Sparkles, Martini, MapPin, List, Link, LoaderCircle, Menu, Megaphone, Folder } from 'lucide';
const icons={ArrowRight, ArrowUpRight, ArrowLeft, Check, X, CircleX, CalendarDays, UsersRound, Package, NotebookPen, ListChecks, Wallet, Settings2, ShieldCheck, History, LayoutDashboard, LogOut, Sprout, Search, Inbox, Plus, Pencil, Copy, Download, UserPlus, GraduationCap, Users, Sparkles, Martini, MapPin, List, Link, LoaderCircle, Menu, Megaphone, Folder};
